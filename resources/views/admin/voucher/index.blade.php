...
@section('content')
    ...
    <div class="card shadow-lg rounded card p-2">
        <div class="card-header" id="#atas">
            ...
            <button type="button" class="btn mb-3 btn-primary float-end" data-bs-toggle="modal" data-bs-target="#vocModal">
                Tambah Voucher
            </button>
                        ...
                        @if (count($vouchers))
                            @foreach ($vouchers as $voucher)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <span class="badge bg-label-primary me-1">{{ $voucher->status }}</span>
                                        </div>
                                    </td>
                                    <td>
